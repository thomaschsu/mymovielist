...
const LandingContent = () => (
    <div className="landingcontent"><table>
        <tbody>
            <tr>
                <td className="table-format-left animated bounceInDown delay-2s"><h5 className="table-heading red-text"><i class="fas fa-user-friends"></i> Share with your friends.</h5><br></br><span>With a thriving community, chat with others and compare lists with friends!</span></td>
            ...
            <tr>
                ...
                <td className="table-right bounceInRight animated delay"><h5 className="table-heading yellow-text"><i class="fas fa-star-half"></i> Score Your Movies</h5><br></br>Score the movies on your list from 0-10. Did you like the movie? Score a 10. Hate the movie? Score a 0.</td>
            </tr>
            <tr>
