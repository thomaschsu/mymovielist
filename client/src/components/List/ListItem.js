...
const ListItem = props => (
  <tr className="list-group-item">
    ...
    <td><a onClick={props.delete} className="btn-floating btn-small waves-effect waves-light red"><i data-title={props.title} className="material-icons">clear</i></a></td>
  </tr>
);
